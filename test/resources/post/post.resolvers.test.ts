        ...
        it('should return a single Post with its author', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(singlePost).to.not.have.keys(['id','content','photo','createdAt','updatedAt']);
        ...
        it('should create a new Post', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(createdPost).to.not.have.keys(['createdAt','updatedAt','comments']);
        ...
        it('should update an existing Post', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(updatedPost).to.not.have.keys(['id','createdAt','updatedAt','author','comments']);
