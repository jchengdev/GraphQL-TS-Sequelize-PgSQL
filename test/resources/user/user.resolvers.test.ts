...
describe('User', () => {
  ...
  beforeEach(() => {
    return db.Comment.destroy({where: {}})
      ...
      .then((user: UserInstance) => db.User.create(
        {
          name: 'Gamora',
  ...
  describe('Queries', () => {
    ...
    describe('application/json', () => {
      ...
      describe('user', () => {
        ...
        it('should return a single User', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(singleUser).to.not.have.keys(['photo','createdAt','updatedAt']);
        ...
        it('should return only \'name\' attribute', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(singleUser).to.not.have.keys(['id','email','photo','createdAt','updatedAt','posts']);
              expect(singleUser.name).to.equal('Peter Quill');
        ...
        it('should return an error if User doesn\'t exist', () => {
          let body = {
            query: `
              query getSingleUser($id: ID!) {
                user(id: $id) {
  ...
  describe('Mutations', () => {
    ...
    describe('application/json', () => {
      ...
      describe('deleteUser', () => {
        ...
        it('should throw an error for missing User', () => {
          let body = {
            query: `
              mutation {
                deleteUser
          ...
          return chai.request(app)
            ...
            .send(JSON.stringify(body))
            .then(res => {
              expect(res.body.errors[0].message).to.equal('Error: User with id null not found!');
            }).catch(handleError);
        });
